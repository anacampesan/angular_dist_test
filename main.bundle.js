...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__userlist_userlist_component__ = __webpack_require__(453);
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__userlist_userlist_component__["a" /* UserlistComponent */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_4__angular_router__["a" /* RouterModule */].forRoot([
                    {
                        path: 'users',
                        component: __WEBPACK_IMPORTED_MODULE_6__userlist_userlist_component__["a" /* UserlistComponent */]
                    }
                ]),
            ],
            providers: [],
...
var UserService = (function () {
    function UserService(http) {
        this.http = http;
        this.usersHttp = 'https://reqres.in/api/users?page=2';
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user_service__ = __webpack_require__(452);
...
module.exports = "<a routerLink=\"/users\">\n  <h1>{{message}}</h1>\n</a>\n<!-- This has to be removed if we don't want to display the user list right away -->\n<!-- <app-userlist [selectedUser]=\"\"></app-userlist> -->\n<router-outlet\n  (activate)='onActivate($event)'\n  (deactivate)='onDeactivate($event)'\n>\n</router-outlet>\n"
